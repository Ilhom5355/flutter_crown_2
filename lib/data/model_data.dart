...
List<Model> models = [
  Model(
    ...
    price: '\$20.00',
    description: 'We hav eamazing Quality Lamp Wide range',
    category: 'Lamp',
  ),
  Model(
    name: 'Stylish Sofa',
  ...
  Model(
    ...
    price: '\$35.00',
    description: 'Amazing stylish in multiple Most selling item of this',
    category: 'Chair',
  ),
  Model(
    name: 'Modern Table',
    ...
    price: '\$20.00',
    description: 'New style of tables for your Homes and office.',
    category: 'Table',
  ),
];
